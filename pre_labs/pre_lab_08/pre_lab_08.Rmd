...
**Answer** It has 3822 rows and 4 columns 
...
**Answer** The first line creates a new dataframe that saves all of the transformations and changes that are done. The second line creates a new column called month and makes the labels Jan, Feb, etc and not numbers. The third line explains that the next changes should be done within the month column. The fourth line creates a smaller data frame with one row per month and a new column called total calls. The fifth line arranges the calls in descending order by most calls to least. The final row allows you to view the data. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now I see a chart with the months on the bottom and count on the left side, ranging from 0 to 300. February seems to be the lowest and March, May and August seem to be tied for the highest. 
...
**Answer** After running the code, the data seems to be arranged from least number of calls to most. The line that did this was x = redorder(month, total_calls)
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We added coord_flip() which changed the x and y axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer** Now, we added theme_minimal() which removes the gray background and cleans the chart. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** Now, there is a blue background with white lines running through the middle of the bars. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? 
**Answer** A heading was added called, More 911 Overdose Calls in Warmer Months. The source was also added in the bottom right corner. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a date calumn with dates from 2022 to 2023 and a total_calls column. There are 366 entries in this column. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a charge with total_calls on the left side from 0 to 20 and date on the bottom running from April 2022 to January 2023. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now, the date lines are all jumbled together and very hard to read. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The date lines have been spaced out a bit more, but still hard to read. The data is arranged by each invidividual entry, but it semms like it still needs to be organized a bit better. 
