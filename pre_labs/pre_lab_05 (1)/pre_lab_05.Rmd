...
**Answer**
There are no headers in the data, there is no way to tell what the numbers that the data provides actually mean. There are also a bunch of periods after all of the counties which is weird formatting. 
...
**Answer** 
The periods after the counties are still there and there are still no headers, just numbers 1 through 12.
...
**Answer**
We still need to get rid of the periods after the counties. 
```{r}
