...
**Answer**
The CSV files have generally the same column structure, with 9 columns: YEAR, COUNTY, DEM, REP, GRN, LIB, UNA, OTH and Total. The only difference is that LIB, GRN and OTH, UNA are switched in the 2020 data vs the 2016 and 2018 data. LIB and GRN are also switched in the 2022 data compared to the 2016 and 2018 data. However, the data sets do have the same columns and general structure. 
...
**Answer**
The county with the highest 18+ Black population as a percentage of all population 18 and over is Prince George' county with ~61%. It's percentage of Democrats is ~78%. 
...
**Answer**
The county with the highest 18+ Asian population as a percentage of all population 18 and over is Howard county with ~19%. It's percentage of democrats is ~52%. Overall, the percentage of Democrats is roughly higher in the dataset of Black voters vs Asian voters with a mean of 55.6% highest 18+ population Black Democrats and highest 18+ population 53.8% Asian Democrats. Also, Howard, Montgomery, Baltimore City, Baltimore County, Prince George's, Anne Arundel, and Charles county are all present on both lists. 
...
**Answer**
The datatype of the ZCTA5N column is <dbl>
