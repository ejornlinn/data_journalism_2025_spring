...
**Answer** The state with the largest percentage growth is Nevada with a 35.1% change
...
**Answer** The Maryland county with the highest media household income is Howard County with a median income of 129,549. 
...
**Answer** The title should be changed to something like Margin of error in calculation for household income by county in Maryland (this is long haha)
...
**Answer** The difference between Calvert and Montgomery is not statistically significant because the bars overlap. The midpoint of Calvert county is at 120000 and the end bar of Montgomery is almost touching 12000. 

Is the difference between Howard and everyone else significant? 
**Answer** The differnce between Howard and everyone else is pretty signifcant, as even Calvert (which is right after Howard) is not overlapping with Howard.
...
**Answer** The jurisdictions that saw the largest increases in median income are Baltimore City with +37.4, Alleganey County with +35.3 and Calvert County with +32.4
...
**Answer** One question we could ask of this data is how does the median household income of a zip code relate to the number of students enrolled in schools in that zip code? Which schools in the zip code have the most amount of enrollment? We could also do this with graduates, how many students are graduating in that school/zip code. 

The answer might be hard to interpret because zip codes do not equal school boundaries. There will be patterns, but there are also other factors other than household income, such as district funding and policy. Many parents may choose to send students to schools far aways from their zip code.
...
**Answer** The average household income for high school students that have 60% of more graduates immediately enrolling in college is 111,448.3. The average for those with less than 40% is 6,9252.24.
...
**Answer** Another question I could ask of this data is whether high school students located in higher income zip codes or counties tend to have a higher percentage of students enrolling in college immediately after graduation compared to those in lower income zip codes or counties. 
